...
export const MATERIALS: Record<string, Material> = {
  /* --- plastics --- */
  'abs-black': { color: '#1C1F24', rough: 0.55, density: 1.04, name: 'ABS, black' },
  'abs-white': { color: '#E8E9EB', rough: 0.5, density: 1.04, name: 'ABS, white' },
  ...
  'epoxy-black': { color: '#15171A', rough: 0.42, density: 1.9, name: 'Epoxy moulding compound' },
  ...
  tin: { color: '#C9CDD4', metal: 1, rough: 0.32, density: 7.31, name: 'Tin plating' },
  ...
  'alu-6063': { color: '#C6CBD2', metal: 1, rough: 0.42, density: 2.7, name: 'Aluminium 6063-T5' },
  'alu-anod-black': { color: '#33373D', metal: 0.9, rough: 0.55, density: 2.7, name: 'Aluminium, black anodised' },
  ...
  nickel: { color: '#B9BCC0', metal: 1, rough: 0.3, density: 8.9, name: 'Nickel plating' },
  ...
  'resistor-beige': { color: '#D2B48C', rough: 0.5, density: 2.2, name: 'Metal film body' },
  ...
  plywood: { color: '#C79A63', rough: 0.72, density: 0.6, name: 'Birch plywood' },
